...
d2 = filter(keys19, date >= "2019-01-01", date <= "2019-03-01")
...
pal2 = c('#8FBC8F', '#20B2AA', '#016450') #manually choose colours
...
d3 = filter(keys19, date >= "2019-03-01", date <= "2019-04-30")
...
pal3 = c('#556B2F', '#9ACD32', '#016450') #manually choose colours
